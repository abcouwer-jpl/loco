...
/* This library was written with the philosophy that assertions be used to
   ...
   This file defines the LOCO_ASSERT macros used in loco.c as
   ROS_ASSERTS.
 */
#define LOCO_ASSERT(test) \
    ROS_ASSERT_MSG(test, \
    "ASSERT in file %s, line %d.", \
    __FILE__, __LINE__)
#define LOCO_ASSERT_1(test, arg1) \
    ROS_ASSERT_MSG((test), \
    "ASSERT in file %s, line %d, arg1 = %d.", \
    __FILE__, __LINE__, (int32_t)(arg1))
#define LOCO_ASSERT_2(test, arg1, arg2) \
    ROS_ASSERT_MSG((test), \
    "ASSERT in file %s, line %d, arg1 = %d, arg2 = %d.", \
    __FILE__, __LINE__, (int32_t)(arg1), (int32_t)(arg2))
#define LOCO_ASSERT_3(test, arg1, arg2, arg3) \
    ROS_ASSERT_MSG((test), \
